...
def inject_v3_css() -> None:
    st.markdown(
        ...
        .bd-entry-hero{max-width:900px;margin:0 auto;padding:11vh 24px 42px;text-align:center}.bd-entry-eyebrow{font-size:11px;line-height:16px;font-weight:700;letter-spacing:.16em;color:#707070}.bd-entry-hero h1{font-family:"Samsung Sharp Sans","SamsungOneKorean",Arial,sans-serif;font-size:clamp(46px,5.5vw,76px);line-height:1.02;letter-spacing:-.045em;margin:20px 0 22px;color:#000}.bd-entry-hero p{max-width:650px;margin:0 auto;color:#555;font-size:17px;line-height:1.6;letter-spacing:-.01em}
        .st-key-bd_entry_composer{max-width:880px;margin:0 auto;padding:14px 16px 12px;border:1px solid #d8d8d8;border-radius:24px;background:#fff;box-shadow:0 14px 38px rgba(0,0,0,.07)}.st-key-bd_entry_composer [data-testid="stTextArea"] textarea{min-height:142px!important;padding:12px 10px!important;background:#fff!important;border:0!important;border-radius:0!important;box-shadow:none!important;font-size:17px;line-height:1.55;resize:none}.st-key-bd_entry_composer [data-testid="stTextArea"] textarea:focus{box-shadow:none!important}.st-key-bd_entry_composer [data-testid="stHorizontalBlock"]{align-items:center;gap:10px}.st-key-bd_entry_composer [data-testid="stPopover"] button{min-height:40px;background:#fff;color:#000;border:1px solid #ddd;padding:8px 14px;font-size:13px}.st-key-bd_entry_composer [data-testid="stPopover"] button:hover{background:#f7f7f7;color:#000;border-color:#aaa}.st-key-bd_entry_composer .stButton>button{min-height:42px;border-radius:21px;padding:9px 18px}
        .bd-entry-modes{display:flex;align-items:center;gap:7px}.bd-entry-modes span{display:inline-flex;align-items:center;height:32px;padding:0 12px;border-radius:16px;color:#707070;font-size:12px;font-weight:700;background:#f4f4f4}.bd-entry-modes span.active{color:#000;background:#e8e8e8}.bd-entry-outcomes{text-align:center;margin:22px auto 0;color:#555;font-size:13px;letter-spacing:.015em}.bd-entry-privacy{text-align:center;margin:10px auto;color:#999;font-size:11px}
        @media(max-width:760px){.v3-head{flex-direction:column}.v3-gate{grid-template-columns:1fr}.v3-meta{grid-template-columns:1fr}.block-container{padding-left:1rem!important;padding-right:1rem!important}.bd-entry-hero{padding:8vh 4px 30px}.bd-entry-hero h1{font-size:42px}.bd-entry-hero p{font-size:15px}.st-key-bd_entry_composer{padding:10px 12px 12px;border-radius:20px}.st-key-bd_entry_composer [data-testid="stHorizontalBlock"]{flex-wrap:wrap}.st-key-bd_entry_composer [data-testid="column"]{min-width:100%!important;width:100%!important}.st-key-bd_entry_composer [data-testid="stPopover"] button,.st-key-bd_entry_composer .stButton>button{width:100%}.bd-entry-modes{margin:2px 0 4px}.bd-entry-outcomes{line-height:1.7;padding:0 24px}}
        </style>
        """,
