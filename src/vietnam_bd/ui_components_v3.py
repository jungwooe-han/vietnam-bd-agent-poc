...
def inject_v3_css() -> None:
    st.markdown(
        ...
        .bd-entry-outcomes{text-align:center;margin:22px auto 0;color:#555;font-size:13px;letter-spacing:.015em}.bd-entry-privacy{text-align:center;margin:10px auto;color:#999;font-size:11px}
        @media(max-width:760px){.v3-head{flex-direction:column}.v3-gate{grid-template-columns:1fr}.v3-meta{grid-template-columns:1fr}.block-container{padding-left:1rem!important;padding-right:1rem!important}.bd-entry-hero{padding:8vh 4px 30px}.bd-entry-hero h1{font-size:42px}.bd-entry-hero p{font-size:15px}.st-key-bd_entry_composer{padding:10px 12px 12px;border-radius:20px}.st-key-bd_entry_composer [data-testid="stHorizontalBlock"]{flex-wrap:wrap}.st-key-bd_entry_composer [data-testid="column"]{min-width:100%!important;width:100%!important}.st-key-bd_entry_composer [data-testid="stPopover"] button,.st-key-bd_entry_composer .stButton>button{width:100%}.bd-entry-outcomes{line-height:1.7;padding:0 24px}}
        </style>
        """,
